...
const ManageSingleBlog = (props) => {
    ...
    const { address, date, name, rating, image, experience, _id, status } = props.experience;
        ...
        <>
            ...
            <div class="px-6 pt-4 pb-2">
                ...
                </span>
                {
                    ...
                    className="bg-green-200 hover:bg-green-500 text-neutral-800 font-bold py-2 px-4 rounded-full">Approve</button>
                }
